...
import AssignEntity from 'modules/views/shared/AssignEntity';
import DeleteEntityButton from 'modules/views/shared/DeleteEntityButton';
import Checkbox from 'modules/views/shared/FormHandler/Checkbox';
import { ControlledError } from 'modules/views/shared';

import { IAssignEntityProps } from 'modules/views/shared/AssignEntity/AssignEntity';
import { ResourceModel } from 'modules/models';
  ...
  return (
    ...
    >
      <Grid item={true} xs={11} className={classes.inputWrapper}>
        <ControlledError show={!!errorMsg} error={!!errorMsg && errorMsg === 'is required' ? `Please enter an active ${title}` : errorMsg}>
