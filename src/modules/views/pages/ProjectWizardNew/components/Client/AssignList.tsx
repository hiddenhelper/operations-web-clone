...
import Chip from 'modules/views/shared/FormHandler/Chip';
import AssignClientRow from './AssignRow';
import AddEntityButton from 'modules/views/shared/AddEntityButton';
  ...
  return (
    <>
      <Card
        ...
        actionStyleClass={`${classes.userAction} ${showAlertMessage ? classes.userActionError : ''}`}
          ...
          return (
            <React.Fragment key={index}>
              <AssignClientRow
                ...
                error={(hasError && uiRelationMap[assignItem.tempId].error) || error}
