...
import AutocompleteAddress from 'modules/views/shared/AutocompleteAddress';
...
import { CountryCode, stateMap } from 'constants/territory';
import { AddressModel, GeneralModel } from 'modules/models';
            ...
            <Grid container={true} spacing={3}>
              <Grid item={true} xs={12}>
                <AutocompleteAddress
                  ...
                  error={getErrors('line1', 'Line 1 is required')}
              ...
              <Grid item={true} xs={12}>
                <div className={classes.errorInputWrapper}>
                  <ControlledError show={!!getErrors('line2')} error={getErrors('line2', 'Line 2 is required.')}>
                    {/* <ControlledError
                      show={!!errors.line2}
                      error={!!errors.line2 && errors.line2 === 'is required' ? 'Line 2 is required.' : errors.line2}>
                    */}
                    <ControlledInput
                  ...
                  <Grid item={true} xs={12} sm={9}>
                    <div className={classes.errorInputWrapper}>
                      <ControlledError show={!!getErrors('city')} error={getErrors('city', 'City is required.')}>
                        {/* <ControlledError
                          show={!!errors.city} error={!!errors.city &&
                          errors.city === 'is required' ? 'City is required.' : errors.city}
                        > */}
                        <ControlledInput
