...
export const mapStateToProps = (state: IRootState) => ({
  ...
  loading: state.general.loadingMap[GENERAL.LOADING_KEY.FETCH_CLIENT_WORKERS_ACTIVITY_WIDGET_STATISTICS],
});

export const mapDispatchToProps = (dispatch: Dispatch) => ({
  fetchWorkersActivityWidget: (key: string, query: GeneralModel.IQueryParams) =>
    dispatch(statisticsState.actions.fetchClientWorkersActivityWidgetStatisticsStart(key, query)),
});
